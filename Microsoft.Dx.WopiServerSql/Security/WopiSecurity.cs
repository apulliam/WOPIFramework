...
namespace Microsoft.Dx.WopiServerSql.Security
{
    /// <summary>
    ...
    public class WopiSecurity
    {
        ...
        /// </summary>
        public static string GetIdentityNameFromToken(string tokenString)
        {
            // Initialize the token handler and validation parameters
            var tokenHandler = new JwtSecurityTokenHandler();
            var tokenValidation = new TokenValidationParameters()
        ...
        /// </summary>
        public JwtSecurityToken GenerateToken(string user)
        {
